 ...
 */
public class RecordTpcdsTableStatsTool
{
    public static void main(String[] args)
    {
        RecordTpcdsTableStatsTool tool = new RecordTpcdsTableStatsTool(new TableStatisticsRecorder(), new TableStatisticsDataRepository());

        ImmutableList.of("tiny", "sf1")
                .forEach(schemaName -> Table.getBaseTables().stream()
    ...
    private RecordTpcdsTableStatsTool(TableStatisticsRecorder tableStatisticsRecorder, TableStatisticsDataRepository tableStatisticsDataRepository)
    {
