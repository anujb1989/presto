...
public final class FailureFunction
{
    ...
    @SqlType("unknown")
    public static void jsonFail(@SqlType(StandardTypes.JSON) Slice failureInfoSlice)
    {
    ...
    @ScalarFunction(value = "fail", hidden = true)
    @SqlType("unknown")
    public static void varcharFail(@SqlType(StandardTypes.VARCHAR) Slice failureMessage)
    {
    ...
    @ScalarFunction(value = "fail", hidden = true)
    @SqlType("unknown")
    public static void varcharFail(
